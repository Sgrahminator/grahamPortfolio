...
const HomePage = () => {
    ...
    return (
        <div>
            ...
            <p>&ldquo;Turning Code into Art: The Digital Canvas of Sarah Graham&rdquo;
            <br></br>
            ...
            imagination. Welcome to my digital canvas — where code comes to life!</p>
            <div>
                <img src="/images/Headshot.jpg" alt="Headshot" />
            </div>
            <p>Meet Sarah Graham, a Versatile Web Developer with a Passion for Impact
            <br></br>
            ...
            <h2>My Projects</h2>
            <p>Github <a href="https://github.com/Sgrahminator" target="_blank" rel="noopener noreferrer">Sarah Graham</a></p>
            <div>
