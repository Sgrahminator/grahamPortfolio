...
const AboutPage = () => {
    return (
        <div>
            <h1>About Me</h1>
            <img src="/images/Headshot2.jpg" alt="Headshot 2" className="img-size" />
            <h3>A Journey from Customer Service to the Heart of Web Development</h3>
            <p>
                ...
                in the dynamic world of web development. Thank you for joining me on this journey!
            </p>
            <ContactCard />
            <h4>
                <a href="pdfs\SarahGraham_Tech_Res_2024.pdf" download>
